#ifndef AMBULANCE_ENVP_STATEOBJECTENCODER_H
#define AMBULANCE_ENVP_STATEOBJECTENCODER_H

#include "ObservationEncoder.h"

class StateObjectEncoder : public ObservationEncoder {
...
#endif //AMBULANCE_ENVP_STATEOBJECTENCODER_H
