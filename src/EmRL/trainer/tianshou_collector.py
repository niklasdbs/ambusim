...
class AmbulanceCollector(Collector):
    def collect(
        self,
        ...
        metrics: DefaultDict[str, List[float]] = defaultdict(list) #todo store somewhere else
        ...
        while True:
            ...
            if np.any(done):
                ...
                new_metrics_mult_envs = self.env.get_env_attr("collect_metrics", env_ind_global)
                
                for new_metrics in new_metrics_mult_envs:
                    [
        ...
        return {**return_stats, **aggregated_metrics}
